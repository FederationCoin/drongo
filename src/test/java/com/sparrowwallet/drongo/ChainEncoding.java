...
public final class ChainEncoding {
    ...
    /**
     * Re-encode Bitcoin xpub/xprv/tpub/tprv tokens in a descriptor. A valid 8-character checksum is recomputed.
     */
    ...
    public static String address(String published) {
        ...
        if(lower.startsWith("bc1") || lower.startsWith("tb1") || lower.startsWith("bcrt1")
            ...
            return Bech32.encode(Network.get().getBech32AddressHRP(), data.encoding, data.data);
        }
        ...
        if(lower.startsWith("spspend1") || lower.startsWith("tspspend1") || lower.startsWith("bcrtspend1")) {
            Bech32.Bech32Data data = Bech32.decode(published, 1023);
            return Bech32.encode(Network.get().getSilentPaymentsSpendKeyHrp(), data.encoding, data.data);
        }
